	<section class="grilla-accesorios-container">
		<a class="btn btn-default btn-volver-accesorios">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9 col-md-7 col-lg-6">
					<h1 class="title-accesorios">accesorios</h1>
				</div>
			</div>
		</div>

		<div class="grilla-accesorios">
			<div class="container">
				<div class="row">
					...
					<div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
						<div class="accesorio-container">
							...
							<div class="detalle-accesorio clearfix">
								<h2>COOLER VINTAGE</h2>
								<p>Para que puedas explorar nuevos paisajes y coleccionar momentos. <strong>#ThisIsLiving</strong></p>
								<a href="" class="btn btn-default btn-comprar">comprar</a>
							</div>
						</div>
					</div>
					<div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
						<div class="accesorio-container">
							...
							<div class="detalle-accesorio clearfix">
								<h2>BUCKET CORONA</h2>
								<p>Ideal para conservar las botellas a <strong>temperatura justa</strong>.</p>
								<a href="" class="btn btn-default btn-comprar">comprar</a>
							</div>
						</div>
					</div>
					<div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
						<div class="accesorio-container">
							...
							<div class="detalle-accesorio clearfix">
								<h2>SILLA DE PLAYA</h2>
								<p>Comfort y estilo junto a la silla de playa Corona</p>
								<a href="" class="btn btn-default btn-comprar">comprar</a>
							</div>
						</div>
					</div>
					<div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
						<div class="accesorio-container">
							...
							<div class="detalle-accesorio clearfix">
								<h2>destapador de madera</h2>
								<p>UNA GRAN EXPERIENCIA COMIENZA <strong>cuando abres una Corona</strong></p>
								<a href="" class="btn btn-default btn-comprar">comprar</a>
							</div>
						</div>
					</div>
 ...
 </section><!-- grilla-accesorios-container -->
